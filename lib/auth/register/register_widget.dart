...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.noTlpnFocusNode ??= FocusNode();

    _model.passwordController ??= TextEditingController();
    _model.passwordFocusNode ??= FocusNode();

    _model.referallController ??= TextEditingController();
    _model.referallFocusNode ??= FocusNode();
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        15.0, 0.0, 15.0, 0.0),
                                    child: TextFormField(
                                      controller: _model.noTlpnController,
                                      focusNode: _model.noTlpnFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        15.0, 0.0, 15.0, 0.0),
                                    child: TextFormField(
                                      controller: _model.referallController,
                                      focusNode: _model.referallFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                          TextCapitalization.characters,
                                      obscureText: false,
